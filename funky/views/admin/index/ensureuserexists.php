...
<form method="post" action="/admin/index">
	<div class="field"><?f()->load->view('fields/text/view', ['field'=>$user->email])?></div>
	<div class="field"><?f()->load->view('fields/password/view', ['field'=>$user->password])?></div>
	<div class="field"><?f()->load->view('fields/set/view', ['field'=>$user->roles])?></div>
	<div class="field">
